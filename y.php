...
<form action="y.php" method="post">
			...
			<input type="text" name="branch" placeholder="Enter Branch" class="btn" value="<?php echo $branch;?>"><br><br>
...
$data[0]= getposts();
$sql = "SELECT sno,roll_no,name,branch,company,salary FROM roll_no_wise WHERE branch='$data[0]'";
