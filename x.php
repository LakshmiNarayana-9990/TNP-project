...
<form action="x.php" method="post">
			...
			<input type="text" name="roll_no" placeholder="Enter Roll no" class="btn" value="<?php echo $roll_no;?>"><br><br>
...
$data[0]= getposts();
$sql = "SELECT sno,roll_no,name,branch,company,salary FROM roll_no_wise WHERE roll_no='$data[0]'";
